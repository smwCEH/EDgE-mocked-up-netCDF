...
def main():
    ...
    netcdf_folder = r'E:\EDgE\seasonal-forecast\data\mock-data-20161219'
    ...
    in_netcdf_path = os.path.join(netcdf_folder, netcdf_file)
    ...
    for cm in cms:
        for hm in hms:
            ...
            out_netcdf_path = os.path.join(netcdf_folder, out_netcdf_file)
